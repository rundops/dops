...
Read [`docs/architecture.md`](docs/architecture.md) before making
structural changes. It documents the directory layout, data flow, persistence
model, risk policy, MCP integration, runbook format, and key design decisions.
